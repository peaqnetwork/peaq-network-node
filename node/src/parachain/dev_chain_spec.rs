...
use peaq_dev_runtime::{
	...
	GenesisAccount, GenesisConfig, InflationManagerConfig, MorConfig, ParachainInfoConfig,
	ParachainStakingConfig, PeaqMorConfig, PeaqPrecompiles, Runtime,
		...
		inflation_manager: InflationManagerConfig {
			inflation_configuration: inflation_manager::InflationConfigurationT {
				base_inflation_parameters: inflation_manager::InflationParametersT {
					effective_inflation_rate: Perbill::from_perthousand(35u32), // 3.5%, 0.035 or 35/1000
					effective_disinflation_rate: Perbill::from_percent(90), // 1%
				},

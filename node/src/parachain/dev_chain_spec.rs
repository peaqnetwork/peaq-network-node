...
/// 64 collators x 100 delegators = 6400 delegators, for live restake / block-stuck testing.
/// Collators from //Collator0..63 (one node can hold all 64 aura keys and author every slot).

...
#### Peaq env
 ...
 ```bash
docker run -v peaq-storage:/chain-data -p 9944:9944 peaq/parachain:peaq-v0.0.109 \
--parachain-id 3338 \
...
#### Peaq env
```bash
git clone --branch peaq-v0.0.109 https://github.com/peaqnetwork/peaq-network-node.git
```

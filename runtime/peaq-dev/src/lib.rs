...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		...
		fn benchmark_metadata(extra: bool) -> (
			...
			list_benchmark!(list, extra, zenlink_stable_amm, ZenlinkStableAmm);
			list_benchmark!(list, extra, zenlink_swap_router, ZenlinkSwapRouter);
			list_benchmark!(list, extra, zenlink_vault, ZenlinkVault);

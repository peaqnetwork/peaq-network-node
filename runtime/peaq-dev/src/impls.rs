...
use pallet_transaction_payment::{OnChargeTransaction, Config};
...
// One PEAQ
pub const PEAQ: Balance = 10u128.pow(TOKEN_DECIMALS);
...
//here--->
// add static amount to fee
// Deduct  Transaction Fee

/*let fee = fee.saturating_add(1000);
      |               -------------- ^^^^ expected associated type, found integer */
// let fee = fee.saturating_add(1000);

let fee = fee + ((3 / 10) * PEAQ).saturated_into();
        // let fee = fee + b"2000";

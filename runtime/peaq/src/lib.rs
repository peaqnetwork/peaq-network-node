...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: Cow::Borrowed("peaq-node"),
	impl_name: Cow::Borrowed("peaq-node"),
	authoring_version: 1,
...
/// Given the 500ms Weight, from which 90% only are used for transactions,
/// the total EVM execution gas limit is: GAS_PER_SECOND * 0.500 * 0.90 ~= 18_000_000.
